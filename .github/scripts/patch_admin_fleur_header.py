...
STYLE_MARKER = "pme-admin-fleur-header-5120"
SCRIPT_MARKER = "pme-admin-fleur-runtime-5120"

style = r'''
<style id="pme-admin-fleur-header-5120">
/* Correctif mobile: entête stable, lisible et sans chevauchement */
@media (max-width: 760px) {
  ...
  header small { margin-top: 6px !important; line-height: 1.35 !important; }
}
...
script = r'''
<script id="pme-admin-fleur-runtime-5120">
(function(){
  'use strict';
  function visible(el){
    if(!el) return false;
  ...
  var observer = new MutationObserver(function(){
    ...
    window.__pmeAdminFleurTimer = setTimeout(refresh, 60);
  });
...
print("Correctif entête mobile + fleur de lys Administration appliqué.")
