...
public class HubActivity extends Activity {
    ...
    private void build(){
        ...
        infoCard(root,"Méthode documentaire","Les contenus militants, partisans, éditoriaux, scientifiques, historiques et gouvernementaux sont séparés. Le nouveau simulateur de transition distingue le coût temporaire, la dette, les actifs, les dépenses permanentes et les scénarios de continuité commerciale avec les États-Unis.");
        TextView footer=tx("OUI Québec • V5.0 • Base stable conservée : V4.6.1",11,MUTED,true);footer.setGravity(Gravity.CENTER);footer.setPadding(0,dp(8),0,dp(8));root.addView(footer);
